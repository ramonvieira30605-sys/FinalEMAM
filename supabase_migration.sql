...
DROP POLICY IF EXISTS "Usuários podem inserir seus próprios checklists" ON public.checklists;
...
DROP POLICY IF EXISTS "Usuários podem excluir seus próprios checklists" ON public.checklists;
...
DROP POLICY IF EXISTS "Usuários podem ver seus próprios documentos" ON public.knowledge_base;
